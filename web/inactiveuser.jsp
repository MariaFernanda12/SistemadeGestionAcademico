    ...
    <div class="Library">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <br>
                        <center>
                            <h1 style="color: #9c9c9c;"><span style="color: black" class="fa fa-user-times"></span><br> Usuario inactivo, por favor ponerse en contacto con el coordinado</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="read-more">
                        <a href="contact2.html">Contactar</a>
                    </div>
                </div>
            </div>
        </div>
